...
\begin{itemize}
        ...
        \item The glyphs most likely to be together should be likely connect easily.
        \item The more simple glyphs should be mapped to the most common symbols.
        \item If certain glyphs are very likely to be together, the possibility of replacing them with one glyph should be evaluated.
\end{itemize}
...
\begin{enumerate}
        ...
        \item During the generation the maximum possible and the average number of control points are set. They have been determined empirically, according to a number of criteria discussed in the following section.
\end{enumerate}
...
\sum^{n}_{i=1}f_ip_i
\]
and the glyphs are picked so that the above formula is maximized.
